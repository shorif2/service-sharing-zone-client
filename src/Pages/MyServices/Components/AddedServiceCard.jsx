...
const AddedServiceCard = ({ myService, myAddedService, setMyAddedService }) => {
    ...
    return (
        <div>
            <div className="py-6 md:py-10 h-full">
                <div className="relative flex w-full h-full flex-col  rounded-xl bg-white bg-clip-border text-gray-700 shadow-lg">
                    <div className="relative h-full mx-4 mt-4 overflow-hidden text-white shadow-lg rounded-xl bg-blue-gray-500 bg-clip-border shadow-blue-gray-500/40">
                        <img className="block"
