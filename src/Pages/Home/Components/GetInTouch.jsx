...
const GetInTouch = () => {
	...
	<div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
		...
		<form  className="flex flex-col py-6 space-y-6 md:py-0 md:px-6">
			...
			<button type="button" className="self-center px-8 py-3 text-lg rounded focus:ring hover:ring focus:ri bg-red-500 text-white font-medium focus:ri hover:ri">Submit</button>
		</form>
	</div>
</section>
        </div>
